...
class Window(QtGui.QWidget,threading.Thread):
    def __init__(self):
        ...
        # 设置该控件尺寸和相对位置
        self.plotWidget_ted.setGeometry(QtCore.QRect(0,0,1920,1050))
        self.plotWidget_ted.addLegend()
        self.label_class = ['Stairs','Jogging','Sitting','Walking','Stairs','Walking','Standing','Sitting']
        ...
        self.timer.start(50)
        self.act = 0
        self.bserial = serial.Serial(port='COM14', baudrate=38400, timeout=0, parity=serial.PARITY_NONE, stopbits=1)
        self.l1 = []
        self.l2 = []
        self.l3 = []
